    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            ...
            case ('blue-yellow'):
                ...
                break;
            case ('jashan'):
                css = ":root{--abbackgrounddark0:#e27d60;--abbackgrounddark1:#85dcba;--abbackgrounddark2:#e8a87c;--abbackgrounddark3:#c38d9e;--abtextlight0:#f5f5f5;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#177ff2;--abstop:#000}";
                break;
            case ('jashan2'):
                css = ":root{--abbackgrounddark0:#e9d8e4;--abbackgrounddark1:#e9d8e4;--abbackgrounddark2:#e9d8e4343f71;--abbackgrounddark3:#e9d8e4;--abtextlight0:#f34c19;--abtextlight1:#f34c19;--abtextlight2:#ababab;--abtextlink:#5ca5f6;--abstop:#000}";
                break;
            case ('custom'):
