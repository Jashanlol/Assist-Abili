    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            case ('red-green'):
                ...
                break;
            case ('blue-yellow'):
                css = ":root{--abbackgrounddark0:#006262;--abbackgrounddark1:#007070;--abbackgrounddark2:#ff0066;--abbackgrounddark3:#930034;--abtextlight0:#f5f5f5;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#000000;--abstop:#000}";
                break;
            case ('jashan'):
