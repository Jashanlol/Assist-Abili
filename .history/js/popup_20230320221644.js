...
chrome.storage.local.get(['dark_mode', 'dyslexia_mode', 'cb_mode1', 'cb_mode2'], function(result){
    document.querySelector('#dark_mode').checked = result.dark_mode;
    document.querySelector('#dyslexia_mode').checked = result.dyslexia_mode;
    document.querySelector('#cb_mode1').checked = result.cb_mode1;
    document.querySelector('#cb_mode2').checked = result.cb_mode2;
})
...
document.querySelectorAll(".sliderknob").forEach(btn => btn.addEventListener("click", changeToPresetCSS));
