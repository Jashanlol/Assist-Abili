    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            ...
            case ('blue-yellow'):
                ...
                break;
            case ('jashan'):
                css = ":root{--abbackgrounddark0:#85dcba;--abbackgrounddark1:#85dcba;--abbackgrounddark2:#85dcba;--abbackgrounddark3:#b26d82;--abtextlight0:#f5f5f5;--abtextlight1:#b26d82;--abtextlight2:#ababab;--abtextlink:#e27d60;--abstop:#000}";
                break;
            case ('vanguard'):
