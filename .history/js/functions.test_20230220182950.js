...
const React = require('src/index.js');
const { render, screen } = require('src/index.js');
const Popup = require('html/popup.html');
...
describe('Popup', () => {
  test('Toggle switch for dark mode appears', () => {
    ...
    // Find the slider element by its label or other unique identifier
    const sliderElement = screen.getByLabelText('slider');

    // Assert that the slider element is visible
