...
function changeToPresetCSS(e) {
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            case ('red-green'):
                css = ":root{--abbackgrounddark0:#CE5939;--abbackgrounddark1:#FF835F;--abbackgrounddark2:#48EB91;--abbackgrounddark3:#554FFF;--abtextlight0:#f5f5f5;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#342DD1;--abstop:#000}";
                break;
            case ('blue-yellow'):
                css = ":root{--abbackgrounddark0:#ff0066;--abbackgrounddark1:#ffe6f2;--abbackgrounddark2:#00e6e6;--abbackgrounddark3:#009999;--abtextlight0:#f5f5f5;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#5ca5f6;--abstop:#000}";
                break;
            case (''):
