    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            ...
            case ('jashan'):
                ...
                break;
            case ('jashan2'):
                css = ":root{--abbackgrounddark0:#fbc40e;--abbackgrounddark1:#343f71;--abbackgrounddark2:#e9d8e4;--abbackgrounddark3:#f34c19;--abtextlight0:#f5f5f5;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#5ca5f6;--abstop:#000}";
                break;
            case ('custom'):
