    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            ...
            case ('blue-yellow'):
                ...
                break;
            case ('jashan'):
                css = ":root{--abbackgrounddark0:#d8e3e9;--abbackgrounddark1:#a9c1ce;--abbackgrounddark2:#85dcba;--abbackgrounddark3:#b26d82;--abtextlight0:#3cb472;--abtextlight1:#3cb472;--abtextlight2:#ababab;--abtextlink:#b26d82;--abstop:#000}";
                break;
            case ('vanguard'):
