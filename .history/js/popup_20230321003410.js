    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            ...
            case ('jashan'):
                ...
                break;
            case ('rose'):
                css = ":root{--abbackgrounddark0:#e9d8e4;--abbackgrounddark1:#e9d8e4;--abbackgrounddark2:#e9d8e4;--abbackgrounddark3:#f34c19;--abtextlight0:#343f71;--abtextlight1:#343f71;--abtextlight2:#ababab;--abtextlink:#f34c19;--abstop:#000}";
                break;
            case ('custom'):
