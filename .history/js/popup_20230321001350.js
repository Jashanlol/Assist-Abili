...
function changeToPresetCSS(e) {
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            case ('red-green'):
                css = ":root{--abbackgrounddark0:#6D5216;--abbackgrounddark1:#d79c07;--abbackgrounddark2:#FFD79E;--abbackgrounddark3:#E0A800;--abtextlight0:#66004d;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#5ca5f6;--abstop:#000}";
                break;
            case ('blue-yellow'):
                css = ":root{--abbackgrounddark0:#006262;--abbackgrounddark1:#007070;--abbackgrounddark2:#ff0066;--abbackgrounddark3:#930034;--abtextlight0:#f5f5f5;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#66004d;--abstop:#000}";
                break;
            case ('jashan'):
