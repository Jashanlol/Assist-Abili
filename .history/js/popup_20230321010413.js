...
function changeToPresetCSS(e) {
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            case ('red-green1'):
                css = ":root{--abbackgrounddark0:#153265;--abbackgrounddark1:#0075F8;--abbackgrounddark2:#5C8EFF;--abbackgrounddark3:#C4CEFF;--abtextlight0:#66004d;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#5ca5f6;--abstop:#000}";
                break;
            case ('red-green2'):
