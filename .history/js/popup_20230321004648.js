    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            ...
            case ('blue-yellow'):
                ...
                break;
            case ('jashan'):
                css = ":root{--abbackgrounddark0:#d8e3e9;--abbackgrounddark1:#a9c1ce;--abbackgrounddark2:#85dcba;--abbackgrounddark3:#b26d82;--abtextlight0:#f5f5f5;--abtextlight1:#b26d82;--abtextlight2:#ababab;--abtextlink:#d9e9db;--abstop:#000}";
                break;
            case ('vanguard'):
