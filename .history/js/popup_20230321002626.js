    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            ...
            case ('jashan'):
                ...
                break;
            case ('jashan2'):
                css = ":root{--abbackgrounddark0:#e9d8e4;--abbackgrounddark1:#343f71;--abbackgrounddark2:#fbc40e;--abbackgrounddark3:#f34c19;--abtextlight0:#e9d8e4;--abtextlight1:#f34c19;--abtextlight2:#ababab;--abtextlink:#5ca5f6;--abstop:#000}";
                break;
            case ('custom'):
