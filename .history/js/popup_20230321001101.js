...
function changeToPresetCSS(e) {
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        let css;
        switch (e.target.id) {
            #E0A800,#F8BB1E,#FFD79E,#6D5216,#A3825C
            case ('red-green'):
                css = ":root{--abbackgrounddark0:#E0A800;--abbackgrounddark1:#F8BB1E;--abbackgrounddark2:#FFD79E;--abbackgrounddark3:#6D5216;--abtextlight0:#66004d;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#342DD1;--abstop:#000}";
                break;
            case ('blue-yellow'):
