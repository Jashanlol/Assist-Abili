    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            ...
            case ('jashan'):
                ...
                break;
            case ('rose'):
                css = ":root{--abbackgrounddark0:#e9d8e4;--abbackgrounddark1:#e9d8e4;--abbackgrounddark2:#e9d8e4;--abbackgrounddark3:#343f71;--abtextlight0:#f34c19;--abtextlight1:#f34c19;--abtextlight2:#ababab;--abtextlink:#5ca5f6;--abstop:#000}";
                break;
            case ('custom'):
