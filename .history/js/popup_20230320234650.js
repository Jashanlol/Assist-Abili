    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            case ('red-green'):
                ...
                break;
            case ('blue-yellow'):
                css = ":root{--abbackgrounddark0:#ff0066;--abbackgrounddark1:#ffe6f2;--abbackgrounddark2:#00e6e6;--abbackgrounddark3:#009999;--abtextlight0:#f5f5f5;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#66004d;--abstop:#000}";
                break;
            case (''):
