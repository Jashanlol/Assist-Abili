...
function changeToPresetCSS(e) {
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            case ('red-green'):
                css = ":root{--abbackgrounddark0:#6D5216;--abbackgrounddark1:#F8BB1E;--abbackgrounddark2:#FFD79E;--abbackgrounddark3:#E0A800;--abtextlight0:#66004d;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#342DD1;--abstop:#000}";
                break;
            case ('blue-yellow'):
