    ...
    chrome.storage.local.get(['dark_css'], function (result) {
        ...
        switch (e.target.id) {
            ...
            case ('jashan'):
                ...
                break;
            case ('jashan2'):
                css = ":root{--abbackgrounddark0:#161616;--abbackgrounddark1:#edf5e1;--abbackgrounddark2:#5cdb95;--abbackgrounddark3:#907163;--abtextlight0:#f5f5f5;--abtextlight1:#e2e2e2;--abtextlight2:#ababab;--abtextlink:#5ca5f6;--abstop:#000}";
                break;
            case ('custom'):
